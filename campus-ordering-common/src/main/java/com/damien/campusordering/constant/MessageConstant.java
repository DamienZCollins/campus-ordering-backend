package com.damien.campusordering.constant;
...
public class MessageConstant {
    ...
    public static final String SETMEAL_ENABLE_FAILED = "套餐中包含未启售菜品，无法启售";
    public static final String SETMEAL_MUST_HAVE_DISH = "套餐必须包含菜品";
